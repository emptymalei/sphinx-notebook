...
html_theme_options = {
   ...
   'github_repo': 'sphinx-notebook',
   'gratipay_user': 'emptymalei',
   'analytics_id': '',
   'description': 'Sphinx Notebook',
}
...
htmlhelp_basename = 'Sphinxnotebookdoc'
...
latex_documents = [
  ('index', 'sphinx-notebook.tex', u'Sphinx Notebook',
   u'Lei Ma', 'manual'),
]
...
man_pages = [
    ('index', 'sphinx-notebook', u'Sphinx Notebook',
     [u'Lei Ma'], 1)
]
...
texinfo_documents = [
  ('index', 'Sphinx Notebook', u'Sphinx Notebook',
   u'Lei Ma', 'Sphinx Notebook', 'Taking notes using sphinx-doc',
   'Miscellaneous'),
]
